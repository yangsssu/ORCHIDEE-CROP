  ...
  !Cette routine calcule les densites de flux de CH4 pour un wetlands dont la water table depth est constante dans le temps et situee à pwater_wt1 cm EN-DESSOUS de la surface du sol
...
MODULE stomate_wet_ch4_pt_ter_wet1
  ! modules used:
  USE ioipsl
!pss+
...
!pss-
  ...
  PRIVATE
  PUBLIC ch4_wet_flux_density_wet1,ch4_wet_flux_density_clear_wet1
...
CONTAINS
  ...
  SUBROUTINE ch4_wet_flux_density_clear_wet1
    firstcall=.TRUE.
  END SUBROUTINE ch4_wet_flux_density_clear_wet1


  SUBROUTINE ch4_wet_flux_density_wet1 ( npts,stempdiag,tsurf,tsurf_year,veget_max,veget,&
...
END SUBROUTINE ch4_wet_flux_density_wet1
!********************************************************************
!!$
...
END MODULE stomate_wet_ch4_pt_ter_wet1
