  ...
  !Cette routine calcule les densites de flux de CH4 pour un wetlands dont la water table depth est constante dans le temps et situee à pwater_wt3 cm EN-DESSOUS de la surface du sol
  ...
  !Dans cette routine, il y a un calcul d oxydation (sur la partie 0; pwater_wt3 cm)
 
MODULE stomate_wet_ch4_pt_ter_wet3
  ! modules used:
  USE ioipsl
!pss+
...
!pss-
  ...
  PRIVATE
  PUBLIC ch4_wet_flux_density_wet3,ch4_wet_flux_density_clear_wet3
...
CONTAINS
  ...
  SUBROUTINE ch4_wet_flux_density_clear_wet3
    firstcall=.TRUE.
  END SUBROUTINE ch4_wet_flux_density_clear_wet3


  SUBROUTINE ch4_wet_flux_density_wet3 ( npts,stempdiag,tsurf,tsurf_year,veget_max,veget,&
...
END SUBROUTINE ch4_wet_flux_density_wet3
!********************************************************************
!!$
...
END MODULE stomate_wet_ch4_pt_ter_wet3
