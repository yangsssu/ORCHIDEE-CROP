  ...
  !Cette routine calcule les densites de flux de CH4 pour un wetlands dont la water table depth est constante dans le temps et situee à pwater_wt2 cm EN-DESSOUS de la surface du sol
  ...
  !Dans cette routine, il y a un calcul d oxydation (sur la partie 0; pwater_wt2 cm)
 
MODULE stomate_wet_ch4_pt_ter_wet2
  ! modules used:
  USE ioipsl
!pss+
...
!pss-
  ...
  PRIVATE
  PUBLIC ch4_wet_flux_density_wet2,ch4_wet_flux_density_clear_wet2
...
CONTAINS
  ...
  SUBROUTINE ch4_wet_flux_density_clear_wet2
    firstcall=.TRUE.
  END SUBROUTINE ch4_wet_flux_density_clear_wet2


  SUBROUTINE ch4_wet_flux_density_wet2 ( npts,stempdiag,tsurf,tsurf_year,veget_max,veget,&
...
! transform from concentration into partial pressure unit
                ...
                aold4=2.*rk*q
!!!!pss debug+
!                write(2, *) 'pssdebug, i, ipoint, q, fpart(ipoint, i), rkh, amhalf, aphalf, h, p, rk, aold1, aold2, aold3, aold4, uo(ipoint, i), uo(ipoint, i-1), uo(ipoint, i+1)', i, ipoint, q, fpart(ipoint, i), rkh, amhalf, aphalf, h, p, rk, aold1, aold2, aold3, aold4, uo(ipoint, i), uo(ipoint, i-1), uo(ipoint, i+1)
                b(ipoint,i)=aold1*uo(ipoint,i-1)+aold2*uo(ipoint,i)+aold3*uo(ipoint,i+1)+aold4
...
END SUBROUTINE ch4_wet_flux_density_wet2
!********************************************************************
!!$
...
END MODULE stomate_wet_ch4_pt_ter_wet2
