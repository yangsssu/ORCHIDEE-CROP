...
% \addcontentsline{toc}{chapter}{ANNEXE B : Table des notations} 
% \markboth{\uppercase{\ Title Notations}}
% {\uppercase{\ Notations}} \thispagestyle{empty} \input{./notation} %
