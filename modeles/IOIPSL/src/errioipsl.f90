MODULE errioipsl
!-
!$Id: errioipsl.f90 2078 2013-06-03 08:55:43Z jgipsl $
!-
...
PRIVATE
!-
PUBLIC :: ipslnlf, ipslerr, ipslerr_act, ipslerr_inq, histerr, ipsldbg, ipslout
!-
...
!---------------------------------------------------------------------
   ...
   ENDIF
   IF (plev == 3) THEN
     WRITE(ipslout,'("Fatal error from IOIPSL. See stdout for more details")')
     STOP 1 
   ENDIF
!---------------------
