MODULE calendar
!-
!$Id: calendar.f90 1519 2011-08-01 09:34:10Z mmaipsl $
!-
...
!---- WRITE(ipslout,*) tmp_str
!---- WRITE(ipslout,*) y_pos,m_pos,d_pos,s_pos
      IF (y_pos > 0) THEN
...
!-----
 ...
 &         itau,next_act_itau,next_check_itau
          ...
          WRITE(ipslout,*) 'ACT-TIME : y, m, d, s : ',year,month,day,sec
          WRITE(ipslout,*) &
