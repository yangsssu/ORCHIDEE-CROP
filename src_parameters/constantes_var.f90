...
!! xz add for spatial pixel parameter
  LOGICAL, SAVE :: impose_pixel = .FALSE.        !! FALSE no, use the consistant    
!$OMP THREADPRIVATE(impose_pixel)
...
!$OMP THREADPRIVATE(iplt_1d)
  LOGICAL, SAVE :: pixeled_para = .FALSE. !! xz add do wd use the pixeled para
!$OMP THREADPRIVATE(pixeled_para)
